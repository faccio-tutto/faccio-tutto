...
const FotovoltaicoPage = () => {
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      {/* Main Content Area: Flex container per sidebar e contenuto principale */}
      <main className="flex flex-col md:flex-row gap-6 px-6 mt-10"> {/* Usato flex-col per mobile, md:flex-row per desktop */}
        {/* Colonna sinistra: pulsanti laterali */}
        <aside className="hidden md:block sticky top-4 h-fit w-full md:w-1/4 lg:w-1/5 xl:w-1/6 z-10"> {/* Reso responsive */}
