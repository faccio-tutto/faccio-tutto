...
const InfissiPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
     ...
     {/* Hero Section */}
     <section className="relative flex flex-col items-center justify-center overflow-hidden h-[600px] sm:h-[700px]">
        ...
        <div className="z-10 text-center p-4 w-full flex flex-col items-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}> {/* Added background color */}
          <div className="max-w-3xl"> {/* Added a max-width to the text container */}
            ...
            <div className="text-justify relative z-20 w-full">
              <p className="text-base sm:text-lg leading-relaxed text-white w-full">
